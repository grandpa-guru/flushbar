...
/// [borderRadius] Adds a radius to corners of Flushbar. Best combined with [aroundPadding]. I do not recommend using it with [showProgressIndicator] or [leftBarIndicatorColor]
...
/// [elevation] Elevation generated by the Flushbar. Leave it null if you don't want a shadow.
/// [elevationShadowColor] Elevation shadow color generated by the Flushbar. Leave it null if you don't want a shadow.
...
class Flushbar<T extends Object> extends StatefulWidget {
  Flushbar(
      ...
      : this.title = title,
        ...
        this.elevationShadowColor = elevationShadowColor,
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: Material(
        ...
        shadowColor: widget.elevationShadowColor,
